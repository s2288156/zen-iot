...
-- 字符集与 admin-service 的建表语句一致（utf8mb4 / utf8mb4_unicode_ci），否则跨库 JOIN 与排序规则会混用。

-- Phase 3：ecs-service（端口 28084）的库，表结构由 ecs-service/src/main/resources/db/migration 的 Flyway 脚本负责
CREATE DATABASE IF NOT EXISTS zen_ecs CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
