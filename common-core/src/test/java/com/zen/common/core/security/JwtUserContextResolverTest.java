...
class JwtUserContextResolverTest {
    ...
    void refreshTokenCannotBeUsedAsAccessToken() {
        ...
        assertThatThrownBy(() -> resolver.resolve(bearer(pair.refreshToken()))).isInstanceOf(BusinessException.class);
    }
    ...
    void revokedTokenIsRejected() {
        ...
        assertThatThrownBy(() -> resolver.resolve(bearer(pair.accessToken()))).isInstanceOf(BusinessException.class);
    }
