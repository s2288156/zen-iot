<template>
  <div class="app-container">
    ...
    <el-table :data="accountPage.data" style="width: 100%">
...
import { ref } from 'vue'
import { AccountPage } from '@/api/system/types'

const pageQuery = new PageQuery(0, 10)
const accountPage = ref<AccountPage>({
  data: [],
  size: 0,
  totalPages: 0
})
const getAccountList = () => {
  getAccounts(pageQuery).then(response => {
    accountPage.value = response.data
  })
}
getAccountList()
</script>
